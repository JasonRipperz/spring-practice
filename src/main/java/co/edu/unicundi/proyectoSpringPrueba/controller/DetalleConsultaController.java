...
public class DetalleConsultaController {
	...
	@GetMapping("/listar")
	public ResponseEntity<List<DetalleConsulta>> listar(Pageable pageable) {
		return new ResponseEntity<List<DetalleConsulta>>(detConsultaRepo.listar(pageable),
				detConsultaRepo.listar(pageable).size() > 0 ? HttpStatus.OK : HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> guardar(@Valid @RequestBody DetalleConsulta consulta)
			throws RepeatedObjectException, ObjectNotFoundException {
	...
	@GetMapping("/listarPorNombreDoctor")
	public ResponseEntity<Page<DetalleConsulta>> listarPorNombreDoctor(String nombreDoctor, Pageable pageable) {
		return new ResponseEntity<Page<DetalleConsulta>>(detConsultaRepo.listarPorNombreDoctor(nombreDoctor, pageable),
				detConsultaRepo.listarPorNombreDoctor(nombreDoctor, pageable).getSize() > 0 ? HttpStatus.OK : HttpStatus.NO_CONTENT);
	}
