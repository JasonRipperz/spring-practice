...
public class ConsultaController {
	...
	public ResponseEntity<Page<Consulta>> listarPorDetalleDiagnostico(String diagnostico, Pageable pageable) {
		return new ResponseEntity<Page<Consulta>>(consultaService.listarPorDetalleDiagnostico(diagnostico, pageable),
				consultaService.listarPorDetalleDiagnostico(diagnostico, pageable).getSize() > 0 ? HttpStatus.OK : HttpStatus.NO_CONTENT);
	}
